locals {
  tags            = { "Agency" = "WaTech", "Billing Code" = "1630-0-1211-CC", "Business Group" = "Watech AID ECC", "Owner" = "Jason Niemi", "Service" = "AI-Sandbox", ProjectName = "Information Assistant", BuildNumber = var.buildNumber }
